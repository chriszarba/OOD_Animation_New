...
/**
 * An interface for the model of the animation project, this extends {@link IReadOnlyModel} to allow
 * mutation. The model stores shapes and motions for those shapes.
 */
public interface IModel extends IReadOnlyModel {

  /**
   * Adds a shape to the model. If any of the parameters are incorrect or the name is already in
   * use, this method will fail.
   *
   ...
   */
  boolean addShape(String name, ShapeType type, Point2D pos, double width, double height,
      Color color);
   ...
   * @return true if the motion was sucessfully added and associated with a shape, false otherwise.
   */
  ...
  /**
   * Set the width of the canvas for the animation.
   *
  ...
  /**
   * Set the height of the canvas for the animation.
   *
  ...
  /**
   * Set the leftmost X value for the animation.
   *
  ...
  /**
   * Set the topmost Y value for the animation.
   *
