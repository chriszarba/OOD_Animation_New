...
public class TestRectangle {
  ...
  public void testNullPos() {
    IShape rect3 = new Rectangle("rectangle", null, Color.BLACK, 0, 0, true);
  }
  ...
  public void testNegativePos() {
    IShape rect3 = new Rectangle("rectangle", new Point2D.Double(-1, -5), Color.BLACK, 0, 0, true);
  }
  ...
  public void testNegativePosX() {
    IShape rect3 = new Rectangle("rectangle", new Point2D.Double(-1, 0), Color.BLACK, 0, 0, true);
  }
  ...
  public void testNegativePosY() {
    IShape rect3 = new Rectangle("rectangle", new Point2D.Double(0, -5), Color.BLACK, 0, 0, true);
  }
  ...
  public void testNullColor() {
    IShape rect3 = new Rectangle("rectangle", new Point2D.Double(0, 0), null, 0, 0, true);
  }
  ...
  public void testNegativeHeight() {
    IShape rect3 = new Rectangle("rectangle", new Point2D.Double(0, 0), Color.BLACK, 0, -1, true);
  }
